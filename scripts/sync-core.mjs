...
export const BLOCKS = [
  ...
  // Data rather than code: the sample the dashboard offers on its empty state.
  // Regenerated by scripts/make-sample.mjs, never edited by hand.
  { name: 'sample', source: join(root, 'pipeline/fixtures/sample-records.js'), marker: 'TYRE-SAMPLE' }
];
